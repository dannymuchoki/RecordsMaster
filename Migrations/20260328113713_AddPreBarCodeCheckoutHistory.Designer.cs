...
namespace RecordsMaster.Migrations
{
    ...
    [Migration("20260328113713_AddPreBarCodeCheckoutHistory")]
    partial class AddPreBarCodeCheckoutHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecordsMaster.Models.CheckoutHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<Guid?>("PreBarCodeRecordId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RecordsMaster.Models.PreBarCodeRecordModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RecordsMaster.Models.CheckoutHistory", b =>
                {
                    b.HasOne("RecordsMaster.Models.PreBarCodeRecordModel", "PreBarCodeRecord")
                        .WithMany("CheckoutHistoryRecords")
                        .HasForeignKey("PreBarCodeRecordId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RecordsMaster.Models.RecordItemModel", "RecordItem")
                        .WithMany("CheckoutHistoryRecords")
            ...
            modelBuilder.Entity("RecordsMaster.Models.PreBarCodeRecordModel", b =>
                {
                    b.Navigation("CheckoutHistoryRecords");
                });
